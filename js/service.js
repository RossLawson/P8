...
var shuttle = null;
    ...
    //NEW objects containing colors for each house
    var houseColor = 
    {
...
$(window).load(function() {
    ...
    //NEW listen for click on velocity increase button
    $("#increase").click(function(event) {
       ...
       //else let user know shuttle is max 100
       else
       {
    ...
    $("#decrease").click(function(event){
        ...
        else //let user know shuttle cant go slower than 0
        {
            $("#display").html("Shuttle cannot go any slower");
        }
    });
    ...
    for (var i = 0, n = shuttle.seats.length; i < n; i++)
    {
        ...
        if(shuttle.seats[i] != null)
        {
            ...
            if (distance < dropDist)
            {
                ...
                {
                    $("#announcements").html("All passengers havebeen picked up and dropped off");
                }
                else
                {
                    //announce players ppoint total
...
function pickup()
{
    ...
    {
        //determine latitude and longitude of passengers
        ...
        {
            //determine if passenger is a freshman
...
function populate()
{
    ...
    for (var i = 0; i < PASSENGERS.length; i++)
    {
        ...
        //remember passengers placemark and marker for pickup
